...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen, print" href="<?php bloginfo('template_url'); ?>/css/slickmap.css" />
</head>
...
<body>
	...
	<div class="sitemap">
		...
		<?php wp_nav_menu( array('theme_location' => 'main_menu', 'container' => '', 'menu_class' => 'col4 main-menu', 'menu_id' => 'primaryNav')); ?>
